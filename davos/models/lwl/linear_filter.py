...
from davos.models.filter import apply_filter
import math
...
class LinearFilter(nn.Module):
    ...
    def apply_target_model(self, weights, feat):
        ...
        mask_encoding = apply_filter(feat, weights, dilation_factors=self.filter_dilation_factors)
        return mask_encoding

    def get_filter(self, feat, train_label, train_sw, num_objects=None, weights_only=False, *args, **kwargs):
